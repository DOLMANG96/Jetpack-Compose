package com.cho.dietapp.repository
    ...
    suspend fun readExercise() : List<Exercise> {
        ...
        return currentUser?.let { user ->
            val documents = db.collection("diet_records")
                ...
                .get()
                .await()
            documents.documents.mapNotNull {documents ->
                documents.toObject(Exercise::class.java)?.copy(docId = documents.id)
            }
        } ?: emptyList()
    }
